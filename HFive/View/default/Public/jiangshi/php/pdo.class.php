...
class pdomysql {
 ...
 public static $dbname = 'jiangshi';
 public static $dbuser = 'root';
 public static $dbpass = '9uL8lHVtbNFE';
 ...
 public function __construct() {
  ...
  self::$dbport = '3306';
  self::$dbname = 'jiangshi';
  self::$dbuser = 'root';
  self::$dbpass = '9uL8lHVtbNFE';
  self::$connect = true;
  self::$charset = 'UTF8';
  self::connect ();
  ...
  * 返回:記录数
  * 类型:数字
  * 參数:$db->update($table,array('title'=>'Zxsv'),array('id'=>'1'),$where='id=3');
  */
