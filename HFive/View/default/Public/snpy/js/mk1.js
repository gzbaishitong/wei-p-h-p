...
Toucher.P5 = Toucher.kR.extend({
    ...
    k: function (d, Τ, M) {
        ...
        var G = B.pageX;
        var Ј = B.pageY;
        this.DO(Y, a, G, Ј, B.Hh, B.as, d, Τ, M)
    },
    end: function (d, J, Ϝ) {
    },
...
E.kl = {
    ...
    ΚΝ: {
        ...
        sa: function (Q, o, Τ, M, T) {
            var j = (Τ - Q) * 0.5, О = (M - o) * 0.5, Y = T * T, Κ = T * Y;
...
(function (exports, undefined) {
    ...
    ProcessQ.prototype = {
        ...
        ІϜ: function (o) {
            ...
            o.src = o.src || o._;
			//console.dir(o.src);
            o.id = o.id || o.src || "id_" + (this.ΚC.length + 1);
        ...
        NЕ: function () {
            var Е = this;
            this.ΚC.forEach(function (F) {
                F.start(Е)
            });
            var Z = this.Cf || 10;
            var B = this.ΚC.length;
            var a = {};
            var m = null;
            function q() {
                if (Е.ΡΑ >= B) {
        ...
        update: function (Χ) {
            ...
            if (this.oВ.І7) {
                if (this.oВ.Τ6(this)) {
                    ...
                    this.Ν3(Χ)
                } else if (this.oВ.ΑM && this.oВ.ΑM(this)) {
                    this.jM(this.oВ, this);
                    if (this.pi) {
                        this.ΡΑ += 1;
                        this.Qx += this.oВ.QΥ;
                        this.Ν3(Χ)
...
var t = {
        ...
        НЅ: function (B) {
            var V = function (Ϝ) {
                var Ρ = Ϝ.length;
                var C = Ϝ.substring(0, Ρ >> 1);
                var W = Ϝ.substring(Ρ >> 1);
                var Ϝ = [];
                for (var Β = C.length - 1; Β >= 0; Β--) {
                    Ϝ.push(C[Β])
                }
...
var d = t.xh(F, function () {
        ...
        kΤ: function () {
            ...
            Ј.ЈM = Ј.kv && H.indexOf("os 8") > 0;
            Ј.CЅ = Ј.kv && H.indexOf("os 9") > 0;
            Ј.MM = /android/.test(H);
...
var C = {
        H: "",
        Р: Ѕ("http://addon.gzbaishitong.com/weiphp/Uploads/Download/snpy/images/share-icon.jpg"),
        C: Ѕ("http://addon.gzbaishitong.com/weiphp/Uploads/Download/snpy/images/share-icon.jpg"),
...
C.ΝΡ = function (Р) {
    return "拍小黄人赢大奖！，我拍了 " + Р.y8 + " 分，你能比我拍的准吗？"
};
C.Ѕ = C.НC;
function Ѕ(U) {
    var K = new Image();
...
var p = [
        {
            id: "bg",
            src: "http://addon.gzbaishitong.com/weiphp/Uploads/Download/snpy/images/3445704582138371603.jpg"
        },
        {
            id: "title",
            src: "http://addon.gzbaishitong.com/weiphp/Uploads/Download/snpy/images/666666.png"
        },
        {
            id: "help",
            src: "http://addon.gzbaishitong.com/weiphp/Uploads/Download/snpy/images/6d1dc5cf456550e0a47ca691a21_p1_mk1.png"
        },
        {
            id: "number",
            src: "http://addon.gzbaishitong.com/weiphp/Uploads/Download/snpy/images/3f251f89642ce9bec62d71e68d1_p1_mk1.png"
        },
        {
            id: "phone-0",
            src: "http://addon.gzbaishitong.com/weiphp/Uploads/Download/snpy/images/6bd2852a69eb16beeb2f07f3253_p1_mk1.png"
        },
		{
            id: "phone-1",
            src: "http://addon.gzbaishitong.com/weiphp/Uploads/Download/snpy/images/6bd2852a69eb16beeb2f07f3253_p1_mk2.png"
        },
		{
            id: "phone-2",
            src: "http://addon.gzbaishitong.com/weiphp/Uploads/Download/snpy/images/6bd2852a69eb16beeb2f07f3253_p1_mk3.png"
        },
        {
            id: "phone-3",
            src: "http://addon.gzbaishitong.com/weiphp/Uploads/Download/snpy/images/ecb5e33b50a16d0404f42e56dd0_p1_mk1.png"
        },
        {
            id: "camera",
            src: "http://addon.gzbaishitong.com/weiphp/Uploads/Download/snpy/images/4ba0d636f21e6f30b447c00a89c_p1_mk1.png"
        },
        {
            id: "share-tip",
            src: "http://addon.gzbaishitong.com/weiphp/Uploads/Download/snpy/images/8175051909340738288.png"
        },
        {
            id: "share-icon",
            src: "http://addon.gzbaishitong.com/weiphp/Uploads/Download/snpy/images/share-icon.jpg"
        }
    ];
(function () {
    Ι.ІM("camera", "http://addon.gzbaishitong.com/weiphp/Uploads/Download/snpy/images/camera.mp3");
    var K = [Ι.get("camera")];
    Sound.JI(K)
}());
var i = i || {};
...
(function (exports, undefined) {
    ...
    Player.prototype = {
        ...
        resize: function () {
            ...
            if (!Player.C1) {
                var Α = Player.C1 = t.ІJ(240, 100, 40, "rgba(0,0,0,0.3)");
                var F = Α.getContext("2d");
            ...
            this.ΟΤ = this.tt + (this.ZР.height - 100 - this.tt - this.C1.height >> 1)
        },
        OА: function (O) {
            if (this.OA) {
                return
        ...
        uT: function (X, f) {
            ...
            /*var M = Math.random() < 0.9 ? 0 : 1; //BOSS出现频率*/
			var Temp_M = Math.random();
			var M = Temp_M < 0.8 ? (Temp_M < 0.5 ? (Temp_M < 0.3 ? 0 : 1) : 2) : 3;
			//console.log(M);
			scorechanged = true;  //重新拍
            ...
            var r = new Phone({
                    ...
                    y: f,
                    type: M,
                    MϜ: t.nu(0, 360) * Math.PI / 180,
                    Оw: 0,
                    wI: t.nu(4 + M * 3, 7 + M * 2) / 10000,
                    ВТ: 0.02,
        ...
        PΝ: function (О, x, m) {
            ...
            О.drawImage(this.C1, this.ZР.width - this.C1.width >> 1, this.ΟΤ);
            if (this.OA) {
                if (this.Ε4) {
                    this.Ε4.PΝ(О, x, m)
                }
...
(function (exports, undefined) {
    ...
    Photo.prototype = {
        ...
        resize: function () {
            ...
            this.ЈI = this.x - 40;
            this.ue = this.y + 300;    //这里是最终分数呈现垂直位置
        ...
        PΝ: function (T, I, Τ) {
            ...
            T.restore();
			var C = this.k6.toFixed(2) + "分";
            var Р = t.DN(T, C, this.ΤR, this.ЈI, this.ue);
			if(scorechanged){
				if(this.k6.toFixed(2) >= 80.00){
					$id("share-tip").style.display = "block";
				}
				// wxshare2(this.k6.toFixed(2));
				//console.log(scorechanged);
				scorechanged = false;
				//console.log(scorechanged);
			}
...
var Н = Best.hg.extend({
        ...
        M: function (І) {
			...
			$id("share-tip").style.display = "none";  //点击领奖消失
        ...
        ar: function (Y, u) {
            ...
            var C = this.Μ_ && !this.BE && !this.paused;
            if (Β) {
                if (this.МЅ) {
                    В.v = null;
                    if (this.Qi > 200) {
...
var M = Best.hg.extend({
        ...
        PΝ: function (Κ, W, G) {
            ...
            //Κ.drawImage(this.xϜ, this.width - this.xϜ.width - 10, 5 + Math.sin(G / 100) * 3);    //点击领奖
            var j = t.Gx(decodeURIComponent(this.pC));
...
var С = new Best.НP({
        ...
        resize: function () {
            ...
            this.CA = Math.min(this.width, this.height);
            ...
            z.style.width = z.parentNode.style.width = this.Cr + "px";
...
window.onload = function () {
	...
	$id("share-tip").addEventListener('click', function(e){
		$.ajax({
			type: "GET",
			url: "../getTicket/ticket.php",
			dataType: "json",
			data: {
				gameName: 'snoopy',
				getTicket: 'success'
			...
			success: function (result) {
				...
				$(".duihuanma").html(result.ticket);
				$(".fouth-page").show();
				$("#container").hide();
				$(".card").click(function(){
					//location.href = "http://mp.weixin.qq.com/s?__biz=MzA5MjMwOTAxOA==&mid=401000733&idx=1&sn=618976aff3b54e9c4c647e71902f4a08&scene=0";
					var erweimabg = $("<div style='width:100%;height:100%;position:absolute;top:0;background:#00436b url(http://addon.gzbaishitong.com/weiphp/Uploads/Download/snpy/images/erweimabg.jpg) top left no-repeat;background-size:100% 100%'></div>");
					var erweima = $("<div><img src='http://addon.gzbaishitong.com/weiphp/Uploads/Download/snpy/images/erweima.png' style='width:100%;height:100%'></div>");
					var aW = window.innerWidth*0.48;
					erweima.css({
						width:aW,
						height:aW,
						top:'37%',
					...
					$(".fouth-page").hide();
					erweimabg.append(erweima);
					$('body').append(erweimabg);
				});
			}
		});
	}, false);
	$id("share-tip").style.display = "none";
}