...
class pdomysql {
 ...
 public static $dbname = 'taiyangka';
...
/*更新表limt_prize*/
public function update_limt_prize($prizeone,$prizetwo){
	$row=self::fetOne("limt_prize","*",TRUE);
	$prizeone = $row['prizeone']-$prizeone;
	$prizetwo = $row['prizetwo']-$prizetwo;
	self::update("limt_prize",array("prizeone"=>$prizeone,"prizetwo"=>$prizetwo),TRUE);
}
}
